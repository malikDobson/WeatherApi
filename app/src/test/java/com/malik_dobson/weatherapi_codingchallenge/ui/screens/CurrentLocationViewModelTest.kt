...
import com.malik_dobson.weatherapi_codingchallenge.data.model.geocoding.LocalNamesModel
import com.malik_dobson.weatherapi_codingchallenge.data.model.weather.CloudsModel
import com.malik_dobson.weatherapi_codingchallenge.data.model.weather.CoordModel
import com.malik_dobson.weatherapi_codingchallenge.data.model.weather.MainModel
import com.malik_dobson.weatherapi_codingchallenge.data.model.weather.SysModel
import com.malik_dobson.weatherapi_codingchallenge.data.model.weather.WeatherModel
import com.malik_dobson.weatherapi_codingchallenge.data.model.weather.WindModel
import com.malik_dobson.weatherapi_codingchallenge.data.repository.Repository
...
class CurrentLocationViewModelTest {
    ...
    fun getWeather_shouldUpdateWeatherState() = runBlocking {
        ...
        val expectedForecast = ForecastModel( cnt = 0, cod = "", list = listOf(), message = 0)
